...
const NewsDetails = ({
  ...
  if (newsArticle?.headerImg) {
    imageLink = urlFor(newsArticle?.headerImg)
  }
          ...
          <div class="flex-shrink max-w-full w-full lg:w-2/3 overflow-hidden">
            <div class="w-full py-3 mb-3">
              <h2 class="text-gray-800 text-3xl font-bold">
                <span class="inline-block h-5 border-l-3 border-red-600 mr-2"></span>  {newsArticle?.heading1}
              </h2>
            </div>
            ...
            <Image width={650} height={800} class="max-w-full h-auto" src={urlFor(newsArticle?.headerImg)} alt="headerImage" />
          ) : (
            ""
          )}
                  ...
                  <div class="relative flex flex-row items-center justify-between overflow-hidden bg-gray-100 dark:bg-gray-900 dark:bg-opacity-20 mt-12 mb-2 px-6 py-2">
                    <div class="my-4 text-sm">
                      ...
                      <span class="mr-2 md:mr-4">
                        ...
                        </svg> by <a class="font-semibold" href="#"> {newsArticle?.jounalist}</a>
                      </span>
                      {/* <!--date--> */}
                      <time class="mr-2 md:mr-4" datetime="2020-10-22 10:00">
                        ...
                        </svg>  {new Intl.DateTimeFormat('en-US', { year: 'numeric', month: 'short', day: 'numeric' }).format(new Date(newsArticle?._createdAt))}
                      </time>
                      {/* <!--view--> */}
                      <span class="mr-2 md:mr-4">
                ...
                <div class="flex flex-wrap flex-row -mx-4 justify-center py-4">
                  ...
                  <div class="flex-shrink max-w-full px-4 w-2/3 sm:w-3/4 md:w-10/12">
                    ...
                    <p class="text-lg leading-normal mb-2 font-semibold text-gray-800 dark:text-gray-100">
                      <span class="font-semibold"> {newsArticle?.jounalist}</span>
                    </p>
                    {/* <!-- website --> */}
                    <p class="mb-1"><a target="_blank" class="text-red-700" href="#">https://bhagwasanatantimes.com/</a></p>
                    {/* <!--description--> */}
